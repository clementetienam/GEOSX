                                       ...
                                       arrayView1d< localIndex > const & partition )
{
  ...
  integer constexpr MAX_CELL_NEIGHBORS = 128;
                                          ...
                                          ( localIndex const ic )
  {
    ...
    meshUtils::forUniqueNeighbors< MAX_CELL_NEIGHBORS >( ic, cellToNode, nodeToCell, minCommonNodes, [&]( localIndex const nbrIdx )
    {
      if( cellGhostRank[nbrIdx] < 0 )
      {
