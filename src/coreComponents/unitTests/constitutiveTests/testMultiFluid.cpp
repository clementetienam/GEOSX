                               ...
                               real64 const absTol = std::numeric_limits< real64 >::max() )
{
  ...
  array2d< real64, compflow::LAYOUT_COMP_PROP > compositionValues( 1, NC );
  for( localIndex i = 0; i < NC; ++i )
  {
    compositionValues[0][i] = compositionInput[i];
  }
  arraySlice1d< real64 const, compflow::USD_COMP_PROP-1 > const composition = compositionValues[0];
  ...
  CompositionalVarContainer< 1, USD_PHASE_PROP-2, USD_PHASE_PROP_DC-2 > phaseFrac {
    GET_FLUID_DATA( fluid, 3, LAYOUT_PHASE_PROP, phaseFractionString ),
    GET_FLUID_DATA( fluid, 3, LAYOUT_PHASE_PROP, dPhaseFraction_dPressureString ),
    GET_FLUID_DATA( fluid, 3, LAYOUT_PHASE_PROP, dPhaseFraction_dTemperatureString ),
    GET_FLUID_DATA( fluid, 4, LAYOUT_PHASE_PROP_DC, dPhaseFraction_dGlobalCompFractionString )
  };

  CompositionalVarContainer< 1, USD_PHASE_PROP-2, USD_PHASE_PROP_DC-2 > phaseDens {
    GET_FLUID_DATA( fluid, 3, LAYOUT_PHASE_PROP, phaseDensityString ),
    GET_FLUID_DATA( fluid, 3, LAYOUT_PHASE_PROP, dPhaseDensity_dPressureString ),
    GET_FLUID_DATA( fluid, 3, LAYOUT_PHASE_PROP, dPhaseDensity_dTemperatureString ),
    GET_FLUID_DATA( fluid, 4, LAYOUT_PHASE_PROP_DC, dPhaseDensity_dGlobalCompFractionString )
  };

  CompositionalVarContainer< 1, USD_PHASE_PROP-2, USD_PHASE_PROP_DC-2 > phaseVisc {
    GET_FLUID_DATA( fluid, 3, LAYOUT_PHASE_PROP, phaseViscosityString ),
    GET_FLUID_DATA( fluid, 3, LAYOUT_PHASE_PROP, dPhaseViscosity_dPressureString ),
    GET_FLUID_DATA( fluid, 3, LAYOUT_PHASE_PROP, dPhaseViscosity_dTemperatureString ),
    GET_FLUID_DATA( fluid, 4, LAYOUT_PHASE_PROP_DC, dPhaseViscosity_dGlobalCompFractionString )
  };
  ...
  CompositionalVarContainer< 0, USD_FLUID_PROP-2, USD_FLUID_PROP_DC-2 > totalDens {
    GET_FLUID_DATA( fluid, 2, LAYOUT_FLUID_PROP, totalDensityString ),
    GET_FLUID_DATA( fluid, 2, LAYOUT_FLUID_PROP, dTotalDensity_dPressureString ),
    GET_FLUID_DATA( fluid, 2, LAYOUT_FLUID_PROP, dTotalDensity_dTemperatureString ),
    GET_FLUID_DATA( fluid, 3, LAYOUT_FLUID_PROP_DC, dTotalDensity_dGlobalCompFractionString )
  };

  auto const & phaseFracCopy     = GET_FLUID_DATA( fluidCopy, 3, LAYOUT_PHASE_PROP, phaseFractionString );
  auto const & phaseDensCopy     = GET_FLUID_DATA( fluidCopy, 3, LAYOUT_PHASE_PROP, phaseDensityString );
  auto const & phaseViscCopy     = GET_FLUID_DATA( fluidCopy, 3, LAYOUT_PHASE_PROP, phaseViscosityString );
  auto const & phaseCompFracCopy = GET_FLUID_DATA( fluidCopy, 4, LAYOUT_PHASE_COMP, phaseCompFractionString );
  auto const & totalDensCopy     = GET_FLUID_DATA( fluidCopy, 2, LAYOUT_FLUID_PROP, totalDensityString );
...
#undef GET_FLUID_DATA
  ...
  constitutive::constitutiveUpdatePassThru( fluidCopy, [&] ( auto & castedFluid )
  {
    ...
    array2d< real64, compflow::LAYOUT_COMP_PROP > compNew( 1, NC );
...
{
  // Copy input values into an array with expected layout
  array2d< real64, compflow::LAYOUT_COMP_PROP > compositionValues( 1, 2 );
  ...
  StackArray< real64, 3, 2, LAYOUT_PHASE_PROP > phaseFraction( 1, 1, 2 );
  StackArray< real64, 3, 2, LAYOUT_PHASE_PROP > dPhaseFraction_dPressure( 1, 1, 2 );
  StackArray< real64, 3, 2, LAYOUT_PHASE_PROP > dPhaseFraction_dTemperature( 1, 1, 2 );
  StackArray< real64, 4, 4, LAYOUT_PHASE_PROP_DC > dPhaseFraction_dGlobalCompFraction( 1, 1, 2, 2 );
  StackArray< real64, 3, 2, LAYOUT_PHASE_PROP > phaseDensity( 1, 1, 2 );
  StackArray< real64, 3, 2, LAYOUT_PHASE_PROP > dPhaseDensity_dPressure( 1, 1, 2 );
  StackArray< real64, 3, 2, LAYOUT_PHASE_PROP > dPhaseDensity_dTemperature( 1, 1, 2 );
  StackArray< real64, 4, 4, LAYOUT_PHASE_PROP_DC > dPhaseDensity_dGlobalCompFraction( 1, 1, 2, 2 );
  StackArray< real64, 3, 2, LAYOUT_PHASE_PROP > phaseMassDensity( 1, 1, 2 );
  StackArray< real64, 3, 2, LAYOUT_PHASE_PROP > dPhaseMassDensity_dPressure( 1, 1, 2 );
  StackArray< real64, 3, 2, LAYOUT_PHASE_PROP > dPhaseMassDensity_dTemperature( 1, 1, 2 );
  StackArray< real64, 4, 4, LAYOUT_PHASE_PROP_DC > dPhaseMassDensity_dGlobalCompFraction( 1, 1, 2, 2 );
  StackArray< real64, 3, 2, LAYOUT_PHASE_PROP > phaseViscosity( 1, 1, 2 );
  StackArray< real64, 3, 2, LAYOUT_PHASE_PROP > dPhaseViscosity_dPressure( 1, 1, 2 );
  StackArray< real64, 3, 2, LAYOUT_PHASE_PROP > dPhaseViscosity_dTemperature( 1, 1, 2 );
  StackArray< real64, 4, 4, LAYOUT_PHASE_PROP_DC > dPhaseViscosity_dGlobalCompFraction( 1, 1, 2, 2 );
  ...
  StackArray< real64, 2, 1, LAYOUT_FLUID_PROP > totalDensity( 1, 1 );
  StackArray< real64, 2, 1, LAYOUT_FLUID_PROP > dTotalDensity_dPressure( 1, 1 );
  StackArray< real64, 2, 1, LAYOUT_FLUID_PROP > dTotalDensity_dTemperature( 1, 1 );
  StackArray< real64, 3, 2, LAYOUT_FLUID_PROP_DC >  dTotalDensity_dGlobalCompFraction( 1, 1, 2 );
