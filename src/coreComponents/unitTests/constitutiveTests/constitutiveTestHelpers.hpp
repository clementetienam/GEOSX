                               ...
                               D_VAR_D_SAT && dVar_dSat_accessor )
{
  ...
  array2d< real64, compflow::LAYOUT_PHASE_PROP > saturationValues( 1, NP );
  for( localIndex i = 0; i < NP; ++i )
  {
    saturationValues[0][i] = saturationInput[i];
  }
  arraySlice1d< real64 const, compflow::USD_PHASE_PROP-1 > const saturation = saturationValues[0];
  ...
  array2d< real64, compflow::LAYOUT_PHASE_PROP > satNew( 1, NP );
