                            ...
                            LAMBDA assembleFunction )
{
                                         ...
                                         ElementSubRegionBase & subRegion )
  {
    ...
    arrayView2d< real64 const, compflow::USD_COMP_PROP > const & compDens =
      subRegion.getReference< array2d< real64, compflow::LAYOUT_COMP_PROP > >( CompositionalMultiphaseHybridFVM::viewKeyStruct::globalCompDensityString() );
    compDens.move( LvArray::MemorySpace::host, false );

    arrayView2d< real64, compflow::USD_COMP_PROP > const & dCompDens =
      subRegion.getReference< array2d< real64, compflow::LAYOUT_COMP_PROP > >( CompositionalMultiphaseHybridFVM::viewKeyStruct::deltaGlobalCompDensityString() );
