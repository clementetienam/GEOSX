    ...
    m_biotCoefficient( m_constitutiveUpdate.getBiotCoefficient() )
  {
    ...
    // extract views into multiphase solver data
    {
      ...
      m_fluidPhaseDensityOld =
        elementSubRegion.template getReference< array2d< real64, compflow::LAYOUT_PHASE_PROP > >( keys::phaseDensityOldString() );
      ...
      m_fluidPhaseSaturationOld =
        elementSubRegion.template getReference< array2d< real64, compflow::LAYOUT_PHASE_PROP > >( keys::phaseVolumeFractionOldString() );

      m_fluidPhaseSaturation =
        elementSubRegion.template getReference< array2d< real64, compflow::LAYOUT_PHASE_PROP > >( keys::phaseVolumeFractionString() );
      m_dFluidPhaseSaturation_dPressure =
        elementSubRegion.template getReference< array2d< real64, compflow::LAYOUT_PHASE_PROP > >( keys::dPhaseVolumeFraction_dPressureString() );
      m_dFluidPhaseSaturation_dGlobalCompDensity =
        elementSubRegion.template getReference< array3d< real64, compflow::LAYOUT_PHASE_PROP_DC > >( keys::dPhaseVolumeFraction_dGlobalCompDensityString() );

      m_dGlobalCompFraction_dGlobalCompDensity =
        elementSubRegion.template getReference< array3d< real64, compflow::LAYOUT_COMP_PROP_DC > >( keys::dGlobalCompFraction_dGlobalCompDensityString() );
    }
  }
...
protected:
  ...
  arrayView3d< real64 const, constitutive::multifluid::USD_PHASE_PROP > m_fluidPhaseDensity;
  arrayView2d< real64 const, compflow::USD_PHASE_PROP > m_fluidPhaseDensityOld;
  arrayView3d< real64 const, constitutive::multifluid::USD_PHASE_PROP > m_dFluidPhaseDensity_dPressure;
  arrayView4d< real64 const, constitutive::multifluid::USD_PHASE_PROP_DC > m_dFluidPhaseDensity_dGlobalCompFraction;
  ...
  arrayView3d< real64 const, constitutive::multifluid::USD_PHASE_PROP > m_fluidPhaseMassDensity;
  arrayView3d< real64 const, constitutive::multifluid::USD_PHASE_PROP > m_dFluidPhaseMassDensity_dPressure;
  arrayView4d< real64 const, constitutive::multifluid::USD_PHASE_PROP_DC > m_dFluidPhaseMassDensity_dGlobalCompFraction;

  arrayView2d< real64 const, compflow::USD_PHASE_PROP > m_fluidPhaseSaturation;
  arrayView2d< real64 const, compflow::USD_PHASE_PROP > m_fluidPhaseSaturationOld;
  arrayView2d< real64 const, compflow::USD_PHASE_PROP > m_dFluidPhaseSaturation_dPressure;
  arrayView3d< real64 const, compflow::USD_PHASE_PROP_DC > m_dFluidPhaseSaturation_dGlobalCompFraction;
  arrayView3d< real64 const, compflow::USD_PHASE_PROP_DC > m_dFluidPhaseSaturation_dGlobalCompDensity;

  arrayView3d< real64 const, compflow::USD_COMP_PROP_DC > m_dGlobalCompFraction_dGlobalCompDensity;
