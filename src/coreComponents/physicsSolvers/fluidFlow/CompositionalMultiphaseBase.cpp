...
void CompositionalMultiphaseBase::registerDataOnMesh( Group & meshBodies )
{
  ...
  meshBodies.forSubGroups< MeshBody >( [&]( MeshBody & meshBody )
  {
    ...
    forTargetSubRegions( mesh, [&]( localIndex const, ElementSubRegionBase & elementSubRegion )
    {
      ...
      elementSubRegion.registerWrapper< array2d< real64, compflow::LAYOUT_COMP_PROP > >( viewKeyStruct::globalCompDensityString() ).
        setPlotLevel( PlotLevel::LEVEL_0 );

      elementSubRegion.registerWrapper< array2d< real64, compflow::LAYOUT_COMP_PROP > >( viewKeyStruct::deltaGlobalCompDensityString() ).
        setRestartFlags( RestartFlags::NO_WRITE );

      elementSubRegion.registerWrapper< array2d< real64, compflow::LAYOUT_COMP_PROP > >( viewKeyStruct::globalCompFractionString() ).
        setPlotLevel( PlotLevel::LEVEL_0 );

      elementSubRegion.registerWrapper< array3d< real64, compflow::LAYOUT_COMP_PROP_DC > >( viewKeyStruct::dGlobalCompFraction_dGlobalCompDensityString() ).
        setRestartFlags( RestartFlags::NO_WRITE );

      elementSubRegion.registerWrapper< array2d< real64, compflow::LAYOUT_PHASE_PROP > >( viewKeyStruct::phaseVolumeFractionString() ).
        setPlotLevel( PlotLevel::LEVEL_0 );

      elementSubRegion.registerWrapper< array2d< real64, compflow::LAYOUT_PHASE_PROP > >( viewKeyStruct::dPhaseVolumeFraction_dPressureString() ).
        setRestartFlags( RestartFlags::NO_WRITE );

      elementSubRegion.registerWrapper< array3d< real64, compflow::LAYOUT_PHASE_PROP_DC > >( viewKeyStruct::dPhaseVolumeFraction_dGlobalCompDensityString() ).
        setRestartFlags( RestartFlags::NO_WRITE );

      elementSubRegion.registerWrapper< array2d< real64, compflow::LAYOUT_PHASE_PROP > >( viewKeyStruct::phaseMobilityString() ).
        setPlotLevel( PlotLevel::LEVEL_0 );

      elementSubRegion.registerWrapper< array2d< real64, compflow::LAYOUT_PHASE_PROP > >( viewKeyStruct::dPhaseMobility_dPressureString() ).
        setRestartFlags( RestartFlags::NO_WRITE );

      elementSubRegion.registerWrapper< array3d< real64, compflow::LAYOUT_PHASE_PROP_DC > >( viewKeyStruct::dPhaseMobility_dGlobalCompDensityString() ).
        setRestartFlags( RestartFlags::NO_WRITE );

      elementSubRegion.registerWrapper< array2d< real64, compflow::LAYOUT_PHASE_PROP > >( viewKeyStruct::phaseVolumeFractionOldString() );
      elementSubRegion.registerWrapper< array1d< real64 > >( viewKeyStruct::totalDensityOldString() );
      elementSubRegion.registerWrapper< array2d< real64, compflow::LAYOUT_PHASE_PROP > >( viewKeyStruct::phaseDensityOldString() );
      elementSubRegion.registerWrapper< array2d< real64, compflow::LAYOUT_PHASE_PROP > >( viewKeyStruct::phaseMobilityOldString() );
...
void CompositionalMultiphaseBase::resizeFields( MeshLevel & meshLevel ) const
{
  ...
  {
    subRegion.getReference< array2d< real64, compflow::LAYOUT_COMP_PROP > >( viewKeyStruct::globalCompDensityString() ).
      resizeDimension< 1 >( NC );
    subRegion.getReference< array2d< real64, compflow::LAYOUT_COMP_PROP > >( viewKeyStruct::deltaGlobalCompDensityString() ).
      resizeDimension< 1 >( NC );

    subRegion.getReference< array2d< real64, compflow::LAYOUT_COMP_PROP > >( viewKeyStruct::globalCompFractionString() ).
      resizeDimension< 1 >( NC );
    subRegion.getReference< array3d< real64, compflow::LAYOUT_COMP_PROP_DC > >( viewKeyStruct::dGlobalCompFraction_dGlobalCompDensityString() ).
      resizeDimension< 1, 2 >( NC, NC );

    subRegion.getReference< array2d< real64, compflow::LAYOUT_PHASE_PROP > >( viewKeyStruct::phaseVolumeFractionString() ).
      resizeDimension< 1 >( NP );
    subRegion.getReference< array2d< real64, compflow::LAYOUT_PHASE_PROP > >( viewKeyStruct::dPhaseVolumeFraction_dPressureString() ).
      resizeDimension< 1 >( NP );
    subRegion.getReference< array3d< real64, compflow::LAYOUT_PHASE_PROP_DC > >( viewKeyStruct::dPhaseVolumeFraction_dGlobalCompDensityString() ).
      resizeDimension< 1, 2 >( NP, NC );

    subRegion.getReference< array2d< real64, compflow::LAYOUT_PHASE_PROP > >( viewKeyStruct::phaseMobilityString() ).
      resizeDimension< 1 >( NP );
    subRegion.getReference< array2d< real64, compflow::LAYOUT_PHASE_PROP > >( viewKeyStruct::dPhaseMobility_dPressureString() ).
      resizeDimension< 1 >( NP );
    subRegion.getReference< array3d< real64, compflow::LAYOUT_PHASE_PROP_DC > >( viewKeyStruct::dPhaseMobility_dGlobalCompDensityString() ).
      resizeDimension< 1, 2 >( NP, NC );

    subRegion.getReference< array2d< real64, compflow::LAYOUT_PHASE_PROP > >( viewKeyStruct::phaseVolumeFractionOldString() ).
      resizeDimension< 1 >( NP );
    subRegion.getReference< array2d< real64, compflow::LAYOUT_PHASE_PROP > >( viewKeyStruct::phaseMobilityOldString() ).
      resizeDimension< 1 >( NP );
    subRegion.getReference< array2d< real64, compflow::LAYOUT_PHASE_PROP > >( viewKeyStruct::phaseDensityOldString() ).
      resizeDimension< 1 >( NP );
...
void CompositionalMultiphaseBase::updateComponentFraction( Group & dataGroup ) const
{
  ...
  arrayView2d< real64, compflow::USD_COMP_PROP > const & compFrac =
    dataGroup.getReference< array2d< real64, compflow::LAYOUT_COMP_PROP > >( viewKeyStruct::globalCompFractionString() );

  arrayView3d< real64, compflow::USD_COMP_PROP_DC > const & dCompFrac_dCompDens =
    dataGroup.getReference< array3d< real64, compflow::LAYOUT_COMP_PROP_DC > >( viewKeyStruct::dGlobalCompFraction_dGlobalCompDensityString() );

  // inputs

  arrayView2d< real64 const, compflow::USD_COMP_PROP > const compDens =
    dataGroup.getReference< array2d< real64, compflow::LAYOUT_COMP_PROP > >( viewKeyStruct::globalCompDensityString() );

  arrayView2d< real64 const, compflow::USD_COMP_PROP > const dCompDens =
    dataGroup.getReference< array2d< real64, compflow::LAYOUT_COMP_PROP > >( viewKeyStruct::deltaGlobalCompDensityString() );
                                                             ...
                                                             localIndex const targetIndex ) const
{
  ...
  arrayView2d< real64, compflow::USD_PHASE_PROP > const phaseVolFrac =
    dataGroup.getReference< array2d< real64, compflow::LAYOUT_PHASE_PROP > >( viewKeyStruct::phaseVolumeFractionString() );

  arrayView2d< real64, compflow::USD_PHASE_PROP > const dPhaseVolFrac_dPres =
    dataGroup.getReference< array2d< real64, compflow::LAYOUT_PHASE_PROP > >( viewKeyStruct::dPhaseVolumeFraction_dPressureString() );

  arrayView3d< real64, compflow::USD_PHASE_PROP_DC > const dPhaseVolFrac_dComp =
    dataGroup.getReference< array3d< real64, compflow::LAYOUT_PHASE_PROP_DC > >( viewKeyStruct::dPhaseVolumeFraction_dGlobalCompDensityString() );
  ...
  arrayView3d< real64 const, multifluid::USD_PHASE_PROP > const & phaseFrac = fluid.phaseFraction();
  arrayView3d< real64 const, multifluid::USD_PHASE_PROP > const & dPhaseFrac_dPres = fluid.dPhaseFraction_dPressure();
  arrayView4d< real64 const, multifluid::USD_PHASE_PROP_DC > const & dPhaseFrac_dComp = fluid.dPhaseFraction_dGlobalCompFraction();

  arrayView3d< real64 const, multifluid::USD_PHASE_PROP > const & phaseDens = fluid.phaseDensity();
  arrayView3d< real64 const, multifluid::USD_PHASE_PROP > const & dPhaseDens_dPres = fluid.dPhaseDensity_dPressure();
  arrayView4d< real64 const, multifluid::USD_PHASE_PROP_DC > const & dPhaseDens_dComp = fluid.dPhaseDensity_dGlobalCompFraction();
...
void CompositionalMultiphaseBase::updateFluidModel( Group & dataGroup, localIndex const targetIndex ) const
{
  ...
  arrayView2d< real64 const, compflow::USD_COMP_PROP > const compFrac =
    dataGroup.getReference< array2d< real64, compflow::LAYOUT_COMP_PROP > >( viewKeyStruct::globalCompFractionString() );
...
void CompositionalMultiphaseBase::updateRelPermModel( Group & dataGroup, localIndex const targetIndex ) const
{
  ...
  arrayView2d< real64 const, compflow::USD_PHASE_PROP > const phaseVolFrac =
    dataGroup.getReference< array2d< real64, compflow::LAYOUT_PHASE_PROP > >( viewKeyStruct::phaseVolumeFractionString() );
...
void CompositionalMultiphaseBase::initializeFluidState( MeshLevel & mesh ) const
{
  ...
  forTargetSubRegions( mesh, [&]( localIndex const targetIndex, ElementSubRegionBase & subRegion )
  {
    ...
    arrayView2d< real64 const, multifluid::USD_FLUID_PROP > const totalDens = fluid.totalDensity();

    arrayView2d< real64 const, compflow::USD_COMP_PROP > const compFrac =
      subRegion.getReference< array2d< real64, compflow::LAYOUT_COMP_PROP > >( viewKeyStruct::globalCompFractionString() );
    arrayView2d< real64, compflow::USD_COMP_PROP > const compDens =
      subRegion.getReference< array2d< real64, compflow::LAYOUT_COMP_PROP > >( viewKeyStruct::globalCompDensityString() );
...
void CompositionalMultiphaseBase::backupFields( MeshLevel & mesh ) const
{
  ...
  forTargetSubRegions( mesh, [&]( localIndex const targetIndex, ElementSubRegionBase & subRegion )
  {
    ...
    arrayView2d< real64 const, compflow::USD_PHASE_PROP > const phaseVolFrac =
      subRegion.getReference< array2d< real64, compflow::LAYOUT_PHASE_PROP > >( viewKeyStruct::phaseVolumeFractionString() );
    arrayView2d< real64 const, compflow::USD_PHASE_PROP > const & phaseMob =
      subRegion.getReference< array2d< real64, compflow::LAYOUT_PHASE_PROP > >( viewKeyStruct::phaseMobilityString() );
    ...
    arrayView2d< real64, compflow::USD_PHASE_PROP > const phaseDensOld =
      subRegion.getReference< array2d< real64, compflow::LAYOUT_PHASE_PROP > >( viewKeyStruct::phaseDensityOldString() );
    arrayView2d< real64, compflow::USD_PHASE_PROP > const phaseVolFracOld =
      subRegion.getReference< array2d< real64, compflow::LAYOUT_PHASE_PROP > >( viewKeyStruct::phaseVolumeFractionOldString() );
    arrayView2d< real64, compflow::USD_PHASE_PROP > const phaseMobOld =
      subRegion.getReference< array2d< real64, compflow::LAYOUT_PHASE_PROP > >( viewKeyStruct::phaseMobilityOldString() );
                                                             ...
                                                             arrayView1d< real64 > const & localRhs ) const
{
  ...
  forTargetSubRegions( mesh, [&]( localIndex const targetIndex, ElementSubRegionBase const & subRegion )
  {
    ...
    arrayView2d< real64 const, compflow::USD_PHASE_PROP > const & dPhaseVolFrac_dPres =
      subRegion.getReference< array2d< real64, compflow::LAYOUT_PHASE_PROP > >( viewKeyStruct::dPhaseVolumeFraction_dPressureString() );
    arrayView3d< real64 const, compflow::USD_PHASE_PROP_DC > const & dPhaseVolFrac_dCompDens =
      subRegion.getReference< array3d< real64, compflow::LAYOUT_PHASE_PROP_DC > >( viewKeyStruct::dPhaseVolumeFraction_dGlobalCompDensityString() );
    arrayView3d< real64 const, compflow::USD_COMP_PROP_DC > const & dCompFrac_dCompDens =
      subRegion.getReference< array3d< real64, compflow::LAYOUT_COMP_PROP_DC > >( viewKeyStruct::dGlobalCompFraction_dGlobalCompDensityString() );
    ...
    arrayView1d< real64 const > const & porosityOld =
      subRegion.getReference< array1d< real64 > >( viewKeyStruct::porosityOldString() );
    arrayView2d< real64 const, compflow::USD_PHASE_PROP > const & phaseVolFracOld =
      subRegion.getReference< array2d< real64, compflow::LAYOUT_PHASE_PROP > >( viewKeyStruct::phaseVolumeFractionOldString() );
    arrayView2d< real64 const, compflow::USD_PHASE_PROP > const & phaseDensOld =
      subRegion.getReference< array2d< real64, compflow::LAYOUT_PHASE_PROP > >( viewKeyStruct::phaseDensityOldString() );
...
void CompositionalMultiphaseBase::resetViews( MeshLevel & mesh )
{
...

  {
    ...
    m_dCompFrac_dCompDens =
      elemManager.constructArrayViewAccessor< real64, 3, LAYOUT_COMP_PROP_DC >( keys::dGlobalCompFraction_dGlobalCompDensityString() );
    ...
    m_dPhaseVolFrac_dPres =
      elemManager.constructArrayViewAccessor< real64, 2, LAYOUT_PHASE_PROP >( keys::dPhaseVolumeFraction_dPressureString() );
    ...
    m_dPhaseVolFrac_dCompDens =
      elemManager.constructArrayViewAccessor< real64, 3, LAYOUT_PHASE_PROP_DC >( keys::dPhaseVolumeFraction_dGlobalCompDensityString() );
    m_dPhaseVolFrac_dCompDens.setName( getName() + "/accessors/" + keys::dPhaseVolumeFraction_dGlobalCompDensityString() );

    m_phaseMob.clear();
    m_phaseMob =
      elemManager.constructArrayViewAccessor< real64, 2, LAYOUT_PHASE_PROP >( keys::phaseMobilityString() );
    m_phaseMob.setName( getName() + "/accessors/" + keys::phaseMobilityString() );

    m_dPhaseMob_dPres.clear();
    m_dPhaseMob_dPres =
      elemManager.constructArrayViewAccessor< real64, 2, LAYOUT_PHASE_PROP >( keys::dPhaseMobility_dPressureString() );
    ...
    m_dPhaseMob_dCompDens =
      elemManager.constructArrayViewAccessor< real64, 3, LAYOUT_PHASE_PROP_DC >( keys::dPhaseMobility_dGlobalCompDensityString() );
    m_dPhaseMob_dCompDens.setName( getName() + "/accessors/" + keys::dPhaseMobility_dGlobalCompDensityString() );

    m_phaseMobOld.clear();
    m_phaseMobOld =
      elemManager.constructArrayViewAccessor< real64, 2, LAYOUT_PHASE_PROP >( keys::phaseMobilityOldString() );
...

  {
    ...
    m_phaseDens.clear();
    m_phaseDens = elemManager.constructMaterialArrayViewAccessor< real64, 3, LAYOUT_PHASE_PROP >( keys::phaseDensityString(),
                                                                                                  targetRegionNames(),
                                                                                                  fluidModelNames() );
    m_phaseDens.setName( getName() + "/accessors/" + keys::phaseDensityString() );

    m_dPhaseDens_dPres.clear();
    m_dPhaseDens_dPres = elemManager.constructMaterialArrayViewAccessor< real64, 3, LAYOUT_PHASE_PROP >( keys::dPhaseDensity_dPressureString(),
                                                                                                         targetRegionNames(),
                                                                                                         fluidModelNames() );
    m_dPhaseDens_dPres.setName( getName() + "/accessors/" + keys::dPhaseDensity_dPressureString() );

    m_dPhaseDens_dComp.clear();
    m_dPhaseDens_dComp = elemManager.constructMaterialArrayViewAccessor< real64, 4, LAYOUT_PHASE_PROP_DC >( keys::dPhaseDensity_dGlobalCompFractionString(),
                                                                                                            targetRegionNames(),
                                                                                                            fluidModelNames() );
    m_dPhaseDens_dComp.setName( getName() + "/accessors/" + keys::dPhaseDensity_dGlobalCompFractionString() );

    m_phaseMassDens.clear();
    m_phaseMassDens = elemManager.constructMaterialArrayViewAccessor< real64, 3, LAYOUT_PHASE_PROP >( keys::phaseMassDensityString(),
                                                                                                      targetRegionNames(),
                                                                                                      fluidModelNames() );
    m_phaseMassDens.setName( getName() + "/accessors/" + keys::phaseMassDensityString() );

    m_dPhaseMassDens_dPres.clear();
    m_dPhaseMassDens_dPres = elemManager.constructMaterialArrayViewAccessor< real64, 3, LAYOUT_PHASE_PROP >( keys::dPhaseMassDensity_dPressureString(),
                                                                                                             targetRegionNames(),
                                                                                                             fluidModelNames() );
    m_dPhaseMassDens_dPres.setName( getName() + "/accessors/" + keys::dPhaseMassDensity_dPressureString() );

    m_dPhaseMassDens_dComp.clear();
    m_dPhaseMassDens_dComp = elemManager.constructMaterialArrayViewAccessor< real64, 4, LAYOUT_PHASE_PROP_DC >( keys::dPhaseMassDensity_dGlobalCompFractionString(),
                                                                                                                targetRegionNames(),
                                                                                                                fluidModelNames() );
