...
void
ComponentFractionKernel::
  compute( arraySlice1d< real64 const, compflow::USD_COMP_PROP-1 > const compDens,
           arraySlice1d< real64 const, compflow::USD_COMP_PROP-1 > const dCompDens,
           arraySlice1d< real64, compflow::USD_COMP_PROP-1 > const compFrac,
           arraySlice2d< real64, compflow::USD_COMP_PROP_DC-1 > const dCompFrac_dCompDens )
{
...
PhaseVolumeFractionKernel::
  compute( arraySlice1d< real64 const, compflow::USD_COMP_PROP-1 > const & compDens,
           arraySlice1d< real64 const, compflow::USD_COMP_PROP-1 > const & dCompDens,
           arraySlice2d< real64 const, compflow::USD_COMP_PROP_DC-1 > const & dCompFrac_dCompDens,
           arraySlice1d< real64 const, constitutive::multifluid::USD_PHASE_PROP-2 > const & phaseDens,
           arraySlice1d< real64 const, constitutive::multifluid::USD_PHASE_PROP-2 > const & dPhaseDens_dPres,
           arraySlice2d< real64 const, constitutive::multifluid::USD_PHASE_PROP_DC-2 > const & dPhaseDens_dComp,
           arraySlice1d< real64 const, constitutive::multifluid::USD_PHASE_PROP-2 > const & phaseFrac,
           arraySlice1d< real64 const, constitutive::multifluid::USD_PHASE_PROP-2 > const & dPhaseFrac_dPres,
           arraySlice2d< real64 const, constitutive::multifluid::USD_PHASE_PROP_DC-2 > const & dPhaseFrac_dComp,
           arraySlice1d< real64, compflow::USD_PHASE_PROP-1 > const & phaseVolFrac,
           arraySlice1d< real64, compflow::USD_PHASE_PROP-1 > const & dPhaseVolFrac_dPres,
           arraySlice2d< real64, compflow::USD_PHASE_PROP_DC-1 > const & dPhaseVolFrac_dComp )
{
  real64 work[NC];
...
void PhaseVolumeFractionKernel::
  launch( localIndex const size,
          ...
          arrayView3d< real64 const, constitutive::multifluid::USD_PHASE_PROP > const & phaseDens,
          arrayView3d< real64 const, constitutive::multifluid::USD_PHASE_PROP > const & dPhaseDens_dPres,
          arrayView4d< real64 const, constitutive::multifluid::USD_PHASE_PROP_DC > const & dPhaseDens_dComp,
          arrayView3d< real64 const, constitutive::multifluid::USD_PHASE_PROP > const & phaseFrac,
          arrayView3d< real64 const, constitutive::multifluid::USD_PHASE_PROP > const & dPhaseFrac_dPres,
          arrayView4d< real64 const, constitutive::multifluid::USD_PHASE_PROP_DC > const & dPhaseFrac_dComp,
...
AccumulationKernel::
  compute( localIndex const numPhases,
           ...
           arraySlice2d< real64 const, compflow::USD_COMP_PROP_DC-1 > const & dCompFrac_dCompDens,
           arraySlice1d< real64 const, compflow::USD_PHASE_PROP-1 > const & phaseVolFracOld,
           arraySlice1d< real64 const, compflow::USD_PHASE_PROP-1 > const & phaseVolFrac,
           arraySlice1d< real64 const, compflow::USD_PHASE_PROP-1 > const & dPhaseVolFrac_dPres,
           arraySlice2d< real64 const, compflow::USD_PHASE_PROP_DC-1 > const & dPhaseVolFrac_dCompDens,
           arraySlice1d< real64 const, compflow::USD_PHASE_PROP-1 > const & phaseDensOld,
           arraySlice1d< real64 const, constitutive::multifluid::USD_PHASE_PROP-2 > const & phaseDens,
           arraySlice1d< real64 const, constitutive::multifluid::USD_PHASE_PROP-2 > const & dPhaseDens_dPres,
           arraySlice2d< real64 const, constitutive::multifluid::USD_PHASE_PROP_DC-2 > const & dPhaseDens_dComp,
