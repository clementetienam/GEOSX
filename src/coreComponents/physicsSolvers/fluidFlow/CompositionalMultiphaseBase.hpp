...
protected:
  ...
  ElementRegionManager::ElementViewAccessor< arrayView3d< real64 const, compflow::USD_COMP_PROP_DC > > m_dCompFrac_dCompDens;

  ElementRegionManager::ElementViewAccessor< arrayView2d< real64 const, compflow::USD_PHASE_PROP > > m_dPhaseVolFrac_dPres;
  ElementRegionManager::ElementViewAccessor< arrayView3d< real64 const, compflow::USD_PHASE_PROP_DC > > m_dPhaseVolFrac_dCompDens;

  ElementRegionManager::ElementViewAccessor< arrayView2d< real64 const, compflow::USD_PHASE_PROP > > m_phaseMob;
  ElementRegionManager::ElementViewAccessor< arrayView2d< real64 const, compflow::USD_PHASE_PROP > > m_dPhaseMob_dPres;
  ElementRegionManager::ElementViewAccessor< arrayView3d< real64 const, compflow::USD_PHASE_PROP_DC > > m_dPhaseMob_dCompDens;

  ElementRegionManager::ElementViewAccessor< arrayView3d< real64 const, constitutive::multifluid::USD_PHASE_PROP > > m_phaseDens;
  ElementRegionManager::ElementViewAccessor< arrayView3d< real64 const, constitutive::multifluid::USD_PHASE_PROP > > m_dPhaseDens_dPres;
  ElementRegionManager::ElementViewAccessor< arrayView4d< real64 const, constitutive::multifluid::USD_PHASE_PROP_DC > > m_dPhaseDens_dComp;

  ElementRegionManager::ElementViewAccessor< arrayView3d< real64 const, constitutive::multifluid::USD_PHASE_PROP > > m_phaseMassDens;
  ElementRegionManager::ElementViewAccessor< arrayView3d< real64 const, constitutive::multifluid::USD_PHASE_PROP > > m_dPhaseMassDens_dPres;
  ElementRegionManager::ElementViewAccessor< arrayView4d< real64 const, constitutive::multifluid::USD_PHASE_PROP_DC > > m_dPhaseMassDens_dComp;
  ...
  ElementRegionManager::ElementViewAccessor< arrayView2d< real64 const, compflow::USD_PHASE_PROP > > m_phaseMobOld;
