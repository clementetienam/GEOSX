...
struct UpwindingHelper
{
  ...
  static void
    upwindViscousCoefficient( localIndex const (&localIds)[ 3 ],
                              ...
                              ElementViewConst< arrayView3d< real64 const, multifluid::USD_PHASE_PROP > > const & phaseDens,
                              ElementViewConst< arrayView3d< real64 const, multifluid::USD_PHASE_PROP > > const & dPhaseDens_dPres,
                              ElementViewConst< arrayView4d< real64 const, multifluid::USD_PHASE_PROP_DC > > const & dPhaseDens_dCompFrac,
                              ...
                              ElementViewConst< arrayView3d< real64 const, compflow::USD_PHASE_PROP_DC > > const & dPhaseMob_dCompDens,
  ...
  static void
    upwindBuoyancyCoefficient( localIndex const (&localIds)[ 3 ],
                               ...
                               ElementViewConst< arrayView4d< real64 const, multifluid::USD_PHASE_PROP_DC > > const & dPhaseMassDens_dCompFrac,
                               ElementViewConst< arrayView2d< real64 const, compflow::USD_PHASE_PROP > > const & phaseMob,
                               ElementViewConst< arrayView2d< real64 const, compflow::USD_PHASE_PROP > > const & dPhaseMob_dPres,
                               ElementViewConst< arrayView3d< real64 const, compflow::USD_PHASE_PROP_DC > > const & dPhaseMob_dCompDens,
                               ElementViewConst< arrayView3d< real64 const, compflow::USD_COMP_PROP_DC > > const & dCompFrac_dCompDens,
...
struct AssemblerKernelHelper
{
  ...
  static void
    applyGradient( arrayView1d< real64 const > const & facePres,
                   ...
                   arraySlice1d< real64 const, multifluid::USD_PHASE_PROP-2 > const & elemPhaseMassDens,
                   arraySlice1d< real64 const, multifluid::USD_PHASE_PROP-2 > const & dElemPhaseMassDens_dPres,
                   arraySlice2d< real64 const, multifluid::USD_PHASE_PROP_DC-2 > const & dElemPhaseMassDens_dCompFrac,
                   arraySlice1d< real64 const, compflow::USD_PHASE_PROP-1 > const & elemPhaseMob,
                   arraySlice1d< real64 const, compflow::USD_PHASE_PROP-1 > const & dElemPhaseMob_dPres,
                   arraySlice2d< real64 const, compflow::USD_PHASE_PROP_DC-1 > const & dElemPhaseMob_dCompDens,
                   arraySlice2d< real64 const, compflow::USD_COMP_PROP_DC-1 > const & dElemCompFrac_dCompDens,
...
struct ResidualNormKernel
{
  ...
  launch( arrayView1d< real64 const > const & localResidual,
          ...
          ElementViewConst< arrayView2d< real64 const, compflow::USD_PHASE_PROP > > const & phaseMobOld,
