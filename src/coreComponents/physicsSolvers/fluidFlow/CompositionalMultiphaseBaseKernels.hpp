...
struct ComponentFractionKernel
{
  ...
  GEOSX_HOST_DEVICE
  static void
  compute( arraySlice1d< real64 const, compflow::USD_COMP_PROP-1 > compDens,
           arraySlice1d< real64 const, compflow::USD_COMP_PROP-1 > dCompDens,
           arraySlice1d< real64, compflow::USD_COMP_PROP-1 > compFrac,
           arraySlice2d< real64, compflow::USD_COMP_PROP_DC-1 > dCompFrac_dCompDens );
...
struct PhaseVolumeFractionKernel
{
  ...
  compute( arraySlice1d< real64 const, compflow::USD_COMP_PROP-1 > const & compDens,
           ...
           arraySlice1d< real64 const, multifluid::USD_PHASE_PROP-2 > const & phaseFrac,
           arraySlice1d< real64 const, multifluid::USD_PHASE_PROP-2 > const & dPhaseFrac_dPres,
           arraySlice2d< real64 const, multifluid::USD_PHASE_PROP_DC-2 > const & dPhaseFrac_dComp,
  ...
  launch( localIndex const size,
          ...
          arrayView3d< real64 const, multifluid::USD_PHASE_PROP > const & phaseFrac,
          arrayView3d< real64 const, multifluid::USD_PHASE_PROP > const & dPhaseFrac_dPres,
          arrayView4d< real64 const, multifluid::USD_PHASE_PROP_DC > const & dPhaseFrac_dComp,
