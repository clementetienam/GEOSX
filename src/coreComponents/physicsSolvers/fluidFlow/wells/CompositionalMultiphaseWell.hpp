...
private:
  ...
  ElementRegionManager::ElementViewAccessor< arrayView2d< real64 const, compflow::USD_COMP_PROP > > m_resCompDens;

  /// views into other reservoir variable fields

  ElementRegionManager::ElementViewAccessor< arrayView2d< real64 const, compflow::USD_PHASE_PROP > > m_resPhaseVolFrac;
  ElementRegionManager::ElementViewAccessor< arrayView2d< real64 const, compflow::USD_PHASE_PROP > > m_dResPhaseVolFrac_dPres;
  ElementRegionManager::ElementViewAccessor< arrayView3d< real64 const, compflow::USD_PHASE_PROP_DC > > m_dResPhaseVolFrac_dCompDens;

  ElementRegionManager::ElementViewAccessor< arrayView3d< real64 const, compflow::USD_COMP_PROP_DC > > m_dResCompFrac_dCompDens;

  /// views into reservoir material fields

  ElementRegionManager::ElementViewAccessor< arrayView3d< real64 const, constitutive::multifluid::USD_PHASE_PROP > > m_resPhaseDens;
  ElementRegionManager::ElementViewAccessor< arrayView3d< real64 const, constitutive::multifluid::USD_PHASE_PROP > > m_dResPhaseDens_dPres;
  ElementRegionManager::ElementViewAccessor< arrayView4d< real64 const, constitutive::multifluid::USD_PHASE_PROP_DC > > m_dResPhaseDens_dComp;

  ElementRegionManager::ElementViewAccessor< arrayView3d< real64 const, constitutive::multifluid::USD_PHASE_PROP > > m_resPhaseMassDens;

  ElementRegionManager::ElementViewAccessor< arrayView3d< real64 const, constitutive::multifluid::USD_PHASE_PROP > > m_resPhaseVisc;
  ElementRegionManager::ElementViewAccessor< arrayView3d< real64 const, constitutive::multifluid::USD_PHASE_PROP > > m_dResPhaseVisc_dPres;
  ElementRegionManager::ElementViewAccessor< arrayView4d< real64 const, constitutive::multifluid::USD_PHASE_PROP_DC > > m_dResPhaseVisc_dComp;
