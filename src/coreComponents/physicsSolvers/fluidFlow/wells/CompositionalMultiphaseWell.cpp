...
void CompositionalMultiphaseWell::registerDataOnMesh( Group & meshBodies )
{
                                                               ...
                                                               WellElementSubRegion & subRegion )
  {
    ...
    subRegion.registerWrapper< array2d< real64, compflow::LAYOUT_COMP_PROP > >( viewKeyStruct::globalCompDensityString() ).
      setPlotLevel( PlotLevel::LEVEL_0 );
    subRegion.registerWrapper< array2d< real64, compflow::LAYOUT_COMP_PROP > >( viewKeyStruct::deltaGlobalCompDensityString() ).
      setRestartFlags( RestartFlags::NO_WRITE );
    ...
    subRegion.registerWrapper< array2d< real64, compflow::LAYOUT_COMP_PROP > >( viewKeyStruct::globalCompFractionString() ).
      setPlotLevel( PlotLevel::LEVEL_0 );
    subRegion.registerWrapper< array3d< real64, compflow::LAYOUT_COMP_PROP_DC > >( viewKeyStruct::dGlobalCompFraction_dGlobalCompDensityString() ).
      setRestartFlags( RestartFlags::NO_WRITE );

    subRegion.registerWrapper< array2d< real64, compflow::LAYOUT_PHASE_PROP > >( viewKeyStruct::phaseVolumeFractionString() ).
      setPlotLevel( PlotLevel::LEVEL_0 );
    subRegion.registerWrapper< array2d< real64, compflow::LAYOUT_PHASE_PROP > >( viewKeyStruct::dPhaseVolumeFraction_dPressureString() ).
      setRestartFlags( RestartFlags::NO_WRITE );
    subRegion.registerWrapper< array3d< real64, compflow::LAYOUT_PHASE_PROP_DC > >( viewKeyStruct::dPhaseVolumeFraction_dGlobalCompDensityString() ).
      setRestartFlags( RestartFlags::NO_WRITE );
    ...
    subRegion.registerWrapper< array1d< real64 > >( viewKeyStruct::dTotalMassDensity_dPressureString() ).
      setRestartFlags( RestartFlags::NO_WRITE );
    subRegion.registerWrapper< array2d< real64, compflow::LAYOUT_FLUID_PROP_DC > >( viewKeyStruct::dTotalMassDensity_dGlobalCompDensityString() ).
      setRestartFlags( RestartFlags::NO_WRITE );
...
void CompositionalMultiphaseWell::resizeFields( WellElementSubRegion & subRegion )
{
  ...
  subRegion.getReference< array2d< real64, compflow::LAYOUT_COMP_PROP > >( viewKeyStruct::globalCompDensityString() ).resizeDimension< 1 >( NC );
  subRegion.getReference< array2d< real64, compflow::LAYOUT_COMP_PROP > >( viewKeyStruct::deltaGlobalCompDensityString() ).resizeDimension< 1 >( NC );

  subRegion.getReference< array2d< real64, compflow::LAYOUT_COMP_PROP > >( viewKeyStruct::globalCompFractionString() ).resizeDimension< 1 >( NC );
  subRegion.getReference< array3d< real64, compflow::LAYOUT_COMP_PROP_DC > >( viewKeyStruct::dGlobalCompFraction_dGlobalCompDensityString() ).resizeDimension< 1, 2 >( NC, NC );

  subRegion.getReference< array2d< real64, compflow::LAYOUT_PHASE_PROP > >( viewKeyStruct::phaseVolumeFractionString() ).resizeDimension< 1 >( NP );
  subRegion.getReference< array2d< real64, compflow::LAYOUT_PHASE_PROP > >( viewKeyStruct::dPhaseVolumeFraction_dPressureString() ).resizeDimension< 1 >( NP );
  subRegion.getReference< array3d< real64, compflow::LAYOUT_PHASE_PROP_DC > >( viewKeyStruct::dPhaseVolumeFraction_dGlobalCompDensityString() ).resizeDimension< 1, 2 >( NP, NC );

  subRegion.getReference< array2d< real64, compflow::LAYOUT_FLUID_PROP_DC > >( viewKeyStruct::dTotalMassDensity_dGlobalCompDensityString() ).resizeDimension< 1 >( NC );
                                                          ...
                                                          localIndex const targetIndex )
{
  ...
  arrayView2d< real64, compflow::USD_FLUID_PROP_DC > const & dTotalMassDens_dCompDens =
    subRegion.getReference< array2d< real64, compflow::LAYOUT_FLUID_PROP_DC > >( viewKeyStruct::dTotalMassDensity_dGlobalCompDensityString() );
...
void CompositionalMultiphaseWell::updatePhaseVolumeFraction( WellElementSubRegion & subRegion, localIndex const targetIndex ) const
{
  ...
  arrayView3d< real64, compflow::USD_PHASE_PROP_DC > const & dPhaseVolFrac_dCompDens =
...
void CompositionalMultiphaseWell::updateTotalMassDensity( WellElementSubRegion & subRegion, localIndex const targetIndex ) const
{
  ...
  arrayView3d< real64 const, multifluid::USD_PHASE_PROP > const & phaseMassDens = fluid.phaseMassDensity();
  arrayView3d< real64 const, multifluid::USD_PHASE_PROP > const & dPhaseMassDens_dPres = fluid.dPhaseMassDensity_dPressure();
  arrayView4d< real64 const, multifluid::USD_PHASE_PROP_DC > const & dPhaseMassDens_dComp = fluid.dPhaseMassDensity_dGlobalCompFraction();
...
void CompositionalMultiphaseWell::initializeWells( DomainPartition & domain )
{
                                                               ...
                                                               WellElementSubRegion & subRegion )
  {
    ...
    arrayView1d< real64 > const & wellElemPressure =
      subRegion.getReference< array1d< real64 > >( viewKeyStruct::pressureString() );
    arrayView2d< real64, compflow::USD_COMP_PROP > const & wellElemCompDens =
      subRegion.getReference< array2d< real64, compflow::LAYOUT_COMP_PROP > >( viewKeyStruct::globalCompDensityString() );
    arrayView1d< real64 > const & connRate =
      subRegion.getReference< array1d< real64 > >( viewKeyStruct::mixtureConnRateString() );

    // get the info stored on well elements
    arrayView2d< real64, compflow::USD_COMP_PROP > const & wellElemCompFrac =
      subRegion.getReference< array2d< real64, compflow::LAYOUT_COMP_PROP > >( viewKeyStruct::globalCompFractionString() );
    arrayView1d< real64 const > const & wellElemGravCoef =
      subRegion.getReference< array1d< real64 > >( viewKeyStruct::gravityCoefString() );
    ...
    MultiFluidBase & fluid = getConstitutiveModel< MultiFluidBase >( subRegion, m_fluidModelNames[targetIndex] );
    arrayView3d< real64 const, multifluid::USD_PHASE_PROP > const & wellElemPhaseDens = fluid.phaseDensity();
    arrayView2d< real64 const, multifluid::USD_FLUID_PROP > const & wellElemTotalDens = fluid.totalDensity();
                                                     ...
                                                     arrayView1d< real64 > const & localRhs )
{
                                                               ...
                                                               WellElementSubRegion const & subRegion )
  {
    ...
    // get the info stored on well elements
    arrayView2d< real64 const, compflow::USD_COMP_PROP > const & wellElemCompFrac =
      subRegion.getReference< array2d< real64, compflow::LAYOUT_COMP_PROP > >( viewKeyStruct::globalCompFractionString() );
    arrayView3d< real64 const, compflow::USD_COMP_PROP_DC > const & dWellElemCompFrac_dCompDens =
      subRegion.getReference< array3d< real64, compflow::LAYOUT_COMP_PROP_DC > >( viewKeyStruct::dGlobalCompFraction_dGlobalCompDensityString() );
                                                              ...
                                                              arrayView1d< real64 > const & localRhs )
{
                                                               ...
                                                               WellElementSubRegion const & subRegion )
  {
    ...
    arrayView2d< real64 const, compflow::USD_PHASE_PROP > const & wellElemPhaseVolFrac =
      subRegion.getReference< array2d< real64, compflow::LAYOUT_PHASE_PROP > >( viewKeyStruct::phaseVolumeFractionString() );
    arrayView2d< real64 const, compflow::USD_PHASE_PROP > const & dWellElemPhaseVolFrac_dPres =
      subRegion.getReference< array2d< real64, compflow::LAYOUT_PHASE_PROP > >( viewKeyStruct::dPhaseVolumeFraction_dPressureString() );
    arrayView3d< real64 const, compflow::USD_PHASE_PROP_DC > const & dWellElemPhaseVolFrac_dComp =
      subRegion.getReference< array3d< real64, compflow::LAYOUT_PHASE_PROP_DC > >( viewKeyStruct::dPhaseVolumeFraction_dGlobalCompDensityString() );
                                                       ...
                                                       arrayView1d< real64 const > const & localSolution )
{
                                                               ...
                                                               WellElementSubRegion const & subRegion )
  {
    ...
    arrayView2d< real64 const, compflow::USD_COMP_PROP > const & wellElemCompDens =
      subRegion.getReference< array2d< real64, compflow::LAYOUT_COMP_PROP > >( viewKeyStruct::globalCompDensityString() );
    arrayView2d< real64 const, compflow::USD_COMP_PROP > const & dWellElemCompDens =
      subRegion.getReference< array2d< real64, compflow::LAYOUT_COMP_PROP > >( viewKeyStruct::deltaGlobalCompDensityString() );
                                                           ...
                                                           localIndex const GEOSX_UNUSED_PARAM( targetIndex ) )
{
  ...
  arrayView1d< real64 const > const & dWellElemTotalMassDens_dPres =
    subRegion.getReference< array1d< real64 > >( viewKeyStruct::dTotalMassDensity_dPressureString() );
  arrayView2d< real64 const, compflow::USD_FLUID_PROP_DC > const & dWellElemTotalMassDens_dCompDens =
    subRegion.getReference< array2d< real64, compflow::LAYOUT_FLUID_PROP_DC > >( viewKeyStruct::dTotalMassDensity_dGlobalCompDensityString() );
...
void CompositionalMultiphaseWell::resetStateToBeginningOfStep( DomainPartition & domain )
{
                                                               ...
                                                               WellElementSubRegion & subRegion )
  {
    ...
    arrayView1d< real64 > const & dWellElemPressure =
      subRegion.getReference< array1d< real64 > >( viewKeyStruct::deltaPressureString() );
    arrayView2d< real64, compflow::USD_COMP_PROP > const & dWellElemGlobalCompDensity =
      subRegion.getReference< array2d< real64, compflow::LAYOUT_COMP_PROP > >( viewKeyStruct::deltaGlobalCompDensityString() );
...
void CompositionalMultiphaseWell::resetViews( DomainPartition & domain )
{
...

  {
    ...
    m_resCompDens.clear();
    m_resCompDens =
      elemManager.constructArrayViewAccessor< real64, 2, LAYOUT_COMP_PROP >( keys::globalCompDensityString() );
    ...
    m_resPhaseVolFrac =
      elemManager.constructArrayViewAccessor< real64, 2, LAYOUT_PHASE_PROP >( keys::phaseVolumeFractionString() );
  ...
  }
  {
    ...
    m_resPhaseDens =
      elemManager.constructMaterialArrayViewAccessor< real64, 3, LAYOUT_PHASE_PROP >( keys::phaseDensityString(),
    ...
    m_dResPhaseDens_dPres =
      elemManager.constructMaterialArrayViewAccessor< real64, 3, LAYOUT_PHASE_PROP >( keys::dPhaseDensity_dPressureString(),
                                                                                      flowSolver.targetRegionNames(),
                                                                                      flowSolver.fluidModelNames() );
    ...
    m_dResPhaseDens_dComp =
      elemManager.constructMaterialArrayViewAccessor< real64, 4, LAYOUT_PHASE_PROP_DC >( keys::dPhaseDensity_dGlobalCompFractionString(),
                                                                                         flowSolver.targetRegionNames(),
                                                                                         flowSolver.fluidModelNames() );
    ...
    m_resPhaseMassDens =
      elemManager.constructMaterialArrayViewAccessor< real64, 3, LAYOUT_PHASE_PROP >( keys::phaseMassDensityString(),
                                                                                      flowSolver.targetRegionNames(),
                                                                                      flowSolver.fluidModelNames() );
    ...
    m_resPhaseVisc =
      elemManager.constructMaterialArrayViewAccessor< real64, 3, LAYOUT_PHASE_PROP >( keys::phaseViscosityString(),
                                                                                      flowSolver.targetRegionNames(),
                                                                                      flowSolver.fluidModelNames() );
    ...
    m_dResPhaseVisc_dPres =
      elemManager.constructMaterialArrayViewAccessor< real64, 3, LAYOUT_PHASE_PROP >( keys::dPhaseViscosity_dPressureString(),
                                                                                      flowSolver.targetRegionNames(),
                                                                                      flowSolver.fluidModelNames() );
    ...
    m_dResPhaseVisc_dComp =
      elemManager.constructMaterialArrayViewAccessor< real64, 4, LAYOUT_PHASE_PROP_DC >( keys::dPhaseViscosity_dGlobalCompFractionString(),
                                                                                         flowSolver.targetRegionNames(),
                                                                                         flowSolver.fluidModelNames() );
                                                        ...
                                                        DomainPartition & domain )
{
                                                               ...
                                                               WellElementSubRegion & subRegion )
  {
    ...
    arrayView2d< real64, compflow::USD_COMP_PROP > const & wellElemGlobalCompDensity =
      subRegion.getReference< array2d< real64, compflow::LAYOUT_COMP_PROP > >( viewKeyStruct::globalCompDensityString() );
    arrayView2d< real64 const, compflow::USD_COMP_PROP > const & dWellElemGlobalCompDensity =
      subRegion.getReference< array2d< real64, compflow::LAYOUT_COMP_PROP > >( viewKeyStruct::deltaGlobalCompDensityString() );
