...
struct PerforationKernel
{
  ...
  launch( localIndex const size,
          ...
          ElementViewConst< arrayView2d< real64 const, compflow::USD_PHASE_PROP > > const & dResPhaseVolFrac_dPres,
          ElementViewConst< arrayView3d< real64 const, compflow::USD_PHASE_PROP_DC > > const & dResPhaseVolFrac_dComp,
          ElementViewConst< arrayView3d< real64 const, compflow::USD_COMP_PROP_DC > > const & dResCompFrac_dCompDens,
          ElementViewConst< arrayView3d< real64 const, multifluid::USD_PHASE_PROP > > const & resPhaseDens,
          ElementViewConst< arrayView3d< real64 const, multifluid::USD_PHASE_PROP > > const & dResPhaseDens_dPres,
          ElementViewConst< arrayView4d< real64 const, multifluid::USD_PHASE_PROP_DC > > const & dResPhaseDens_dComp,
          ElementViewConst< arrayView3d< real64 const, multifluid::USD_PHASE_PROP > > const & resPhaseVisc,
          ElementViewConst< arrayView3d< real64 const, multifluid::USD_PHASE_PROP > > const & dResPhaseVisc_dPres,
          ElementViewConst< arrayView4d< real64 const, multifluid::USD_PHASE_PROP_DC > > const & dResPhaseVisc_dComp,
...
struct PresCompFracInitializationKernel
{
  ...
  launch( localIndex const perforationSize,
          ...
          ElementViewConst< arrayView2d< real64 const, compflow::USD_COMP_PROP > > const & resCompDens,
          ElementViewConst< arrayView2d< real64 const, compflow::USD_PHASE_PROP > > const & resPhaseVolFrac,
          ElementViewConst< arrayView3d< real64 const, multifluid::USD_PHASE_PROP > > const & resPhaseMassDens,
          arrayView1d< localIndex const > const & resElementRegion,
          arrayView1d< localIndex const > const & resElementSubRegion,
          arrayView1d< localIndex const > const & resElementIndex,
          arrayView1d< real64 const > const & wellElemGravCoef,
...
struct CompDensInitializationKernel
{
  ...
  launch( localIndex const subRegionSize,
          localIndex const numComponents,
          arrayView2d< real64 const, compflow::USD_COMP_PROP > const & wellElemCompFrac,
          arrayView2d< real64 const, multifluid::USD_FLUID_PROP > const & wellElemTotalDens,
...
struct RateInitializationKernel
{
  ...
  launch( localIndex const subRegionSize,
          ...
          arrayView2d< real64 const, multifluid::USD_FLUID_PROP > const & totalDens,
...
struct TotalMassDensityKernel
{
  ...
  launch( localIndex const subRegionSize,
          ...
          arrayView3d< real64 const, multifluid::USD_PHASE_PROP > const & phaseMassDens,
          arrayView3d< real64 const, multifluid::USD_PHASE_PROP > const & dPhaseMassDens_dPres,
          arrayView4d< real64 const, multifluid::USD_PHASE_PROP_DC > const & dPhaseMassDens_dComp,
...
struct ResidualNormKernel
{
  ...
  launch( LOCAL_VECTOR const localResidual,
          ...
          arrayView1d< globalIndex const > const & wellElemDofNumber,
          arrayView1d< integer const > const & wellElemGhostRank,
          arrayView3d< real64 const, multifluid::USD_PHASE_PROP > const & wellElemPhaseDens,
          arrayView2d< real64 const, multifluid::USD_FLUID_PROP > const & wellElemTotalDens,
          real64 const dt,
