...
using LAYOUT_COMP_PROP = RAJA::PERM_JI;

/// Component global fraction compositional derivative array layout
using LAYOUT_COMP_PROP_DC = RAJA::PERM_JKI;

/// Phase property array layout
using LAYOUT_PHASE_PROP = RAJA::PERM_JI;

/// Phase property array layout
using LAYOUT_PHASE_PROP_DC = RAJA::PERM_JKI;

/// Phase composition array layout
using LAYOUT_PHASE_COMP = RAJA::PERM_JKI;

/// Fluid property compositional derivative array layout
using LAYOUT_FLUID_PROP_DC = RAJA::PERM_JI;

#else

/// Component global density/fraction array layout
using LAYOUT_COMP_PROP = RAJA::PERM_IJ;

/// Component global fraction compositional derivative array layout
using LAYOUT_COMP_PROP_DC = RAJA::PERM_IJK;

/// Phase property array layout
using LAYOUT_PHASE_PROP = RAJA::PERM_IJ;

/// Phase property array layout
using LAYOUT_PHASE_PROP_DC = RAJA::PERM_IJK;

/// Phase composition array layout
using LAYOUT_PHASE_COMP = RAJA::PERM_IJK;

/// Fluid property compositional derivative array layout
using LAYOUT_FLUID_PROP_DC = RAJA::PERM_IJ;

#endif

/// Component global density/fraction unit stride dimension
static constexpr int USD_COMP_PROP = LvArray::typeManipulation::getStrideOneDimension( LAYOUT_COMP_PROP{} );

/// Component global fraction compositional derivative unit stride dimension
static constexpr int USD_COMP_PROP_DC = LvArray::typeManipulation::getStrideOneDimension( LAYOUT_COMP_PROP_DC{} );
