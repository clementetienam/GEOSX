...
public:
  ...
  virtual void compute( real64 const pressure,
                        ...
                        arraySlice1d< real64, multifluid::USD_FLUID_PROP_DC-2 > const & dTotalDensity_dGlobalCompFraction ) const override;
  ...
  virtual void update( localIndex const k,
                       ...
                       real64 const temperature,
                       arraySlice1d< real64 const, compflow::USD_COMP_PROP-1 > const & composition ) const override
  {
    compute( pressure,
             temperature,
             composition,
...
public:
  ...
  MultiFluidPVTPackageWrapper( string const & name,
                               Group * const parent );
...
GEOSX_HOST_DEVICE
inline void
MultiFluidPVTPackageWrapperUpdate::compute( real64 const pressure,
                                            real64 const temperature,
                                            arraySlice1d< real64 const, compflow::USD_COMP_PROP-1 > const & composition,
                                            arraySlice1d< real64, multifluid::USD_PHASE_PROP-2 > const & phaseFrac,
                                            arraySlice1d< real64, multifluid::USD_PHASE_PROP-2 > const & phaseDens,
                                            arraySlice1d< real64, multifluid::USD_PHASE_PROP-2 > const & phaseMassDens,
                                            arraySlice1d< real64, multifluid::USD_PHASE_PROP-2 > const & phaseVisc,
...
GEOSX_HOST_DEVICE
inline void
MultiFluidPVTPackageWrapperUpdate::compute( real64 pressure,
                                            real64 temperature,
                                            arraySlice1d< real64 const, compflow::USD_COMP_PROP-1 > const & composition,
                                            arraySlice1d< real64, multifluid::USD_PHASE_PROP-2 > const & phaseFraction,
                                            arraySlice1d< real64, multifluid::USD_PHASE_PROP-2 > const & dPhaseFraction_dPressure,
                                            ...
                                            real64 & dTotalDensity_dPressure,
                                            real64 & dTotalDensity_dTemperature,
                                            arraySlice1d< real64, multifluid::USD_FLUID_PROP_DC-2 > const & dTotalDensity_dGlobalCompFraction ) const
{
#if defined(__CUDA_ARCH__)
  GEOSX_ERROR( "This function cannot be used on GPU" );
#else
// 0. make shortcut structs to avoid long names (TODO maybe remove)
  CompositionalVarContainer< 1, multifluid::USD_PHASE_PROP-2, multifluid::USD_PHASE_PROP_DC-2 > phaseFrac{
    phaseFraction,
    dPhaseFraction_dPressure,
    dPhaseFraction_dTemperature,
    dPhaseFraction_dGlobalCompFraction
  ...
  CompositionalVarContainer< 1, multifluid::USD_PHASE_PROP-2, multifluid::USD_PHASE_PROP_DC-2 > phaseDens{
    phaseDensity,
    dPhaseDensity_dPressure,
    dPhaseDensity_dTemperature,
    dPhaseDensity_dGlobalCompFraction
  ...
  CompositionalVarContainer< 1, multifluid::USD_PHASE_PROP-2, multifluid::USD_PHASE_PROP_DC-2 > phaseMassDens{
    phaseMassDensity,
    dPhaseMassDensity_dPressure,
    dPhaseMassDensity_dTemperature,
    dPhaseMassDensity_dGlobalCompFraction
  ...
  CompositionalVarContainer< 1, multifluid::USD_PHASE_PROP-2, multifluid::USD_PHASE_PROP_DC-2 > phaseVisc{
    phaseViscosity,
    dPhaseViscosity_dPressure,
    dPhaseViscosity_dTemperature,
    dPhaseViscosity_dGlobalCompFraction
  ...
  CompositionalVarContainer< 0, multifluid::USD_FLUID_PROP-2, multifluid::USD_FLUID_PROP_DC-2 > totalDens{
    totalDensity,
    dTotalDensity_dPressure,
    dTotalDensity_dTemperature,
    dTotalDensity_dGlobalCompFraction
