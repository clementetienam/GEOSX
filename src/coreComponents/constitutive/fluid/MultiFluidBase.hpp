...
protected:
  ...
  MultiFluidBaseUpdate( arrayView1d< real64 const > const & componentMolarWeight,
                        bool const useMass,
                        arrayView3d< real64, multifluid::USD_PHASE_PROP > const & phaseFraction,
                        arrayView3d< real64, multifluid::USD_PHASE_PROP > const & dPhaseFraction_dPressure,
                        arrayView3d< real64, multifluid::USD_PHASE_PROP > const & dPhaseFraction_dTemperature,
                        arrayView4d< real64, multifluid::USD_PHASE_PROP_DC > const & dPhaseFraction_dGlobalCompFraction,
                        arrayView3d< real64, multifluid::USD_PHASE_PROP > const & phaseDensity,
                        arrayView3d< real64, multifluid::USD_PHASE_PROP > const & dPhaseDensity_dPressure,
                        arrayView3d< real64, multifluid::USD_PHASE_PROP > const & dPhaseDensity_dTemperature,
                        arrayView4d< real64, multifluid::USD_PHASE_PROP_DC > const & dPhaseDensity_dGlobalCompFraction,
                        arrayView3d< real64, multifluid::USD_PHASE_PROP > const & phaseMassDensity,
                        arrayView3d< real64, multifluid::USD_PHASE_PROP > const & dPhaseMassDensity_dPressure,
                        arrayView3d< real64, multifluid::USD_PHASE_PROP > const & dPhaseMassDensity_dTemperature,
                        arrayView4d< real64, multifluid::USD_PHASE_PROP_DC > const & dPhaseMassDensity_dGlobalCompFraction,
                        arrayView3d< real64, multifluid::USD_PHASE_PROP > const & phaseViscosity,
                        arrayView3d< real64, multifluid::USD_PHASE_PROP > const & dPhaseViscosity_dPressure,
                        arrayView3d< real64, multifluid::USD_PHASE_PROP > const & dPhaseViscosity_dTemperature,
                        arrayView4d< real64, multifluid::USD_PHASE_PROP_DC > const & dPhaseViscosity_dGlobalCompFraction,
                        ...
                        arrayView2d< real64, multifluid::USD_FLUID_PROP > const & totalDensity,
                        arrayView2d< real64, multifluid::USD_FLUID_PROP > const & dTotalDensity_dPressure,
                        arrayView2d< real64, multifluid::USD_FLUID_PROP > const & dTotalDensity_dTemperature,
                        arrayView3d< real64, multifluid::USD_FLUID_PROP_DC > const & dTotalDensity_dGlobalCompFraction )
  ...
  arrayView3d< real64, multifluid::USD_PHASE_PROP > m_phaseFraction;
  arrayView3d< real64, multifluid::USD_PHASE_PROP > m_dPhaseFraction_dPressure;
  arrayView3d< real64, multifluid::USD_PHASE_PROP > m_dPhaseFraction_dTemperature;
  arrayView4d< real64, multifluid::USD_PHASE_PROP_DC > m_dPhaseFraction_dGlobalCompFraction;

  arrayView3d< real64, multifluid::USD_PHASE_PROP > m_phaseDensity;
  arrayView3d< real64, multifluid::USD_PHASE_PROP > m_dPhaseDensity_dPressure;
  arrayView3d< real64, multifluid::USD_PHASE_PROP > m_dPhaseDensity_dTemperature;
  arrayView4d< real64, multifluid::USD_PHASE_PROP_DC > m_dPhaseDensity_dGlobalCompFraction;

  arrayView3d< real64, multifluid::USD_PHASE_PROP > m_phaseMassDensity;
  arrayView3d< real64, multifluid::USD_PHASE_PROP > m_dPhaseMassDensity_dPressure;
  arrayView3d< real64, multifluid::USD_PHASE_PROP > m_dPhaseMassDensity_dTemperature;
  arrayView4d< real64, multifluid::USD_PHASE_PROP_DC > m_dPhaseMassDensity_dGlobalCompFraction;

  arrayView3d< real64, multifluid::USD_PHASE_PROP > m_phaseViscosity;
  arrayView3d< real64, multifluid::USD_PHASE_PROP > m_dPhaseViscosity_dPressure;
  arrayView3d< real64, multifluid::USD_PHASE_PROP > m_dPhaseViscosity_dTemperature;
  arrayView4d< real64, multifluid::USD_PHASE_PROP_DC > m_dPhaseViscosity_dGlobalCompFraction;
  ...
  arrayView2d< real64, multifluid::USD_FLUID_PROP > m_totalDensity;
  arrayView2d< real64, multifluid::USD_FLUID_PROP > m_dTotalDensity_dPressure;
  arrayView2d< real64, multifluid::USD_FLUID_PROP > m_dTotalDensity_dTemperature;
  arrayView3d< real64, multifluid::USD_FLUID_PROP_DC > m_dTotalDensity_dGlobalCompFraction;
...
private:
  ...
  virtual void compute( real64 const pressure,
                        ...
                        arraySlice1d< real64 const, compflow::USD_COMP_PROP-1 > const & composition,
                        arraySlice1d< real64, multifluid::USD_PHASE_PROP-2 > const & phaseFraction,
                        arraySlice1d< real64, multifluid::USD_PHASE_PROP-2 > const & phaseDensity,
                        arraySlice1d< real64, multifluid::USD_PHASE_PROP-2 > const & phaseMassDensity,
                        arraySlice1d< real64, multifluid::USD_PHASE_PROP-2 > const & phaseViscosity,
  ...
  virtual void compute( real64 const pressure,
                        ...
                        arraySlice1d< real64 const, compflow::USD_COMP_PROP-1 > const & composition,
                        arraySlice1d< real64, multifluid::USD_PHASE_PROP-2 > const & phaseFraction,
                        arraySlice1d< real64, multifluid::USD_PHASE_PROP-2 > const & dPhaseFraction_dPressure,
                        arraySlice1d< real64, multifluid::USD_PHASE_PROP-2 > const & dPhaseFraction_dTemperature,
                        arraySlice2d< real64, multifluid::USD_PHASE_PROP_DC-2 > const & dPhaseFraction_dGlobalCompFraction,
                        arraySlice1d< real64, multifluid::USD_PHASE_PROP-2 > const & phaseDensity,
                        arraySlice1d< real64, multifluid::USD_PHASE_PROP-2 > const & dPhaseDensity_dPressure,
                        arraySlice1d< real64, multifluid::USD_PHASE_PROP-2 > const & dPhaseDensity_dTemperature,
                        arraySlice2d< real64, multifluid::USD_PHASE_PROP_DC-2 > const & dPhaseDensity_dGlobalCompFraction,
                        arraySlice1d< real64, multifluid::USD_PHASE_PROP-2 > const & phaseMassDensity,
                        arraySlice1d< real64, multifluid::USD_PHASE_PROP-2 > const & dPhaseMassDensity_dPressure,
                        arraySlice1d< real64, multifluid::USD_PHASE_PROP-2 > const & dPhaseMassDensity_dTemperature,
                        arraySlice2d< real64, multifluid::USD_PHASE_PROP_DC-2 > const & dPhaseMassDensity_dGlobalCompFraction,
                        arraySlice1d< real64, multifluid::USD_PHASE_PROP-2 > const & phaseViscosity,
                        arraySlice1d< real64, multifluid::USD_PHASE_PROP-2 > const & dPhaseViscosity_dPressure,
                        arraySlice1d< real64, multifluid::USD_PHASE_PROP-2 > const & dPhaseViscosity_dTemperature,
                        arraySlice2d< real64, multifluid::USD_PHASE_PROP_DC-2 > const & dPhaseViscosity_dGlobalCompFraction,
                        arraySlice2d< real64, multifluid::USD_PHASE_COMP-2 > const & phaseCompFraction,
                        ...
                        arraySlice1d< real64, multifluid::USD_FLUID_PROP_DC-2 > const & dTotalDensity_dGlobalCompFraction ) const = 0;
  ...
  virtual void update( localIndex const k,
                       ...
                       real64 const temperature,
                       arraySlice1d< real64 const, compflow::USD_COMP_PROP-1 > const & composition ) const = 0;
};
...
public:
  ...
  arrayView3d< real64 const, multifluid::USD_PHASE_PROP > phaseFraction() const
  { return m_phaseFraction; }

  arrayView3d< real64 const, multifluid::USD_PHASE_PROP > dPhaseFraction_dPressure() const
  { return m_dPhaseFraction_dPressure; }

  arrayView3d< real64 const, multifluid::USD_PHASE_PROP > dPhaseFraction_dTemperature() const
  { return m_dPhaseFraction_dTemperature; }

  arrayView4d< real64 const, multifluid::USD_PHASE_PROP_DC > dPhaseFraction_dGlobalCompFraction() const
  { return m_dPhaseFraction_dGlobalCompFraction; }

  arrayView3d< real64 const, multifluid::USD_PHASE_PROP > phaseDensity() const
  { return m_phaseDensity; }

  arrayView3d< real64 const, multifluid::USD_PHASE_PROP > dPhaseDensity_dPressure() const
  { return m_dPhaseDensity_dPressure; }

  arrayView3d< real64 const, multifluid::USD_PHASE_PROP > dPhaseDensity_dTemperature() const
  { return m_dPhaseDensity_dTemperature; }

  arrayView4d< real64 const, multifluid::USD_PHASE_PROP_DC > dPhaseDensity_dGlobalCompFraction() const
  { return m_dPhaseDensity_dGlobalCompFraction; }

  arrayView3d< real64 const, multifluid::USD_PHASE_PROP > phaseMassDensity() const
  { return m_phaseMassDensity; }

  arrayView3d< real64 const, multifluid::USD_PHASE_PROP > dPhaseMassDensity_dPressure() const
  { return m_dPhaseMassDensity_dPressure; }

  arrayView3d< real64 const, multifluid::USD_PHASE_PROP > dPhaseMassDensity_dTemperature() const
  { return m_dPhaseMassDensity_dTemperature; }

  arrayView4d< real64 const, multifluid::USD_PHASE_PROP_DC > dPhaseMassDensity_dGlobalCompFraction() const
  { return m_dPhaseMassDensity_dGlobalCompFraction; }

  arrayView3d< real64 const, multifluid::USD_PHASE_PROP > phaseViscosity() const
  { return m_phaseViscosity; }

  arrayView3d< real64 const, multifluid::USD_PHASE_PROP > dPhaseViscosity_dPressure() const
  { return m_dPhaseViscosity_dPressure; }

  arrayView3d< real64 const, multifluid::USD_PHASE_PROP > dPhaseViscosity_dTemperature() const
  { return m_dPhaseViscosity_dTemperature; }

  arrayView4d< real64 const, multifluid::USD_PHASE_PROP_DC > dPhaseViscosity_dGlobalCompFraction() const
  ...
  arrayView2d< real64 const, multifluid::USD_FLUID_PROP > totalDensity() const
  { return m_totalDensity; }

  arrayView2d< real64 const, multifluid::USD_FLUID_PROP > dTotalDensity_dPressure() const
  { return m_dTotalDensity_dPressure; }

  arrayView2d< real64 const, multifluid::USD_FLUID_PROP > dTotalDensity_dTemperature() const
  { return m_dTotalDensity_dTemperature; }

  arrayView3d< real64 const, multifluid::USD_FLUID_PROP_DC > dTotalDensity_dGlobalCompFraction() const
...
protected:
  ...
  array3d< real64, multifluid::LAYOUT_PHASE_PROP > m_phaseFraction;
  array3d< real64, multifluid::LAYOUT_PHASE_PROP > m_dPhaseFraction_dPressure;
  array3d< real64, multifluid::LAYOUT_PHASE_PROP > m_dPhaseFraction_dTemperature;
  array4d< real64, multifluid::LAYOUT_PHASE_PROP_DC > m_dPhaseFraction_dGlobalCompFraction;

  array3d< real64, multifluid::LAYOUT_PHASE_PROP > m_phaseDensity;
  array3d< real64, multifluid::LAYOUT_PHASE_PROP > m_dPhaseDensity_dPressure;
  array3d< real64, multifluid::LAYOUT_PHASE_PROP > m_dPhaseDensity_dTemperature;
  array4d< real64, multifluid::LAYOUT_PHASE_PROP_DC > m_dPhaseDensity_dGlobalCompFraction;

  array3d< real64, multifluid::LAYOUT_PHASE_PROP > m_phaseMassDensity;
  array3d< real64, multifluid::LAYOUT_PHASE_PROP > m_dPhaseMassDensity_dPressure;
  array3d< real64, multifluid::LAYOUT_PHASE_PROP > m_dPhaseMassDensity_dTemperature;
  array4d< real64, multifluid::LAYOUT_PHASE_PROP_DC > m_dPhaseMassDensity_dGlobalCompFraction;

  array3d< real64, multifluid::LAYOUT_PHASE_PROP > m_phaseViscosity;
  array3d< real64, multifluid::LAYOUT_PHASE_PROP > m_dPhaseViscosity_dPressure;
  array3d< real64, multifluid::LAYOUT_PHASE_PROP > m_dPhaseViscosity_dTemperature;
  array4d< real64, multifluid::LAYOUT_PHASE_PROP_DC > m_dPhaseViscosity_dGlobalCompFraction;
  ...
  array2d< real64, multifluid::LAYOUT_FLUID_PROP > m_totalDensity;
  array2d< real64, multifluid::LAYOUT_FLUID_PROP > m_dTotalDensity_dPressure;
  array2d< real64, multifluid::LAYOUT_FLUID_PROP > m_dTotalDensity_dTemperature;
  array3d< real64, multifluid::LAYOUT_FLUID_PROP_DC > m_dTotalDensity_dGlobalCompFraction;
