...
private:
  ...
  void computeDensities( real64 pressure,
                         arraySlice1d< real64, multifluid::USD_PHASE_PROP-2 > const & phaseMassDens ) const;

  GEOSX_HOST_DEVICE
  void computeDensities( real64 pressure,
                         arraySlice1d< real64, multifluid::USD_PHASE_PROP-2 > const & phaseMassDens,
                         arraySlice1d< real64, multifluid::USD_PHASE_PROP-2 > const & dPhaseMassDens_dPres,
                         arraySlice2d< real64, multifluid::USD_PHASE_PROP_DC-2 > const & dPhaseMassDens_dGlobalCompFrac ) const;

  GEOSX_HOST_DEVICE
  void computeViscosities( real64 pressure,
                           arraySlice1d< real64, multifluid::USD_PHASE_PROP-2 > const & phaseVisc ) const;

  GEOSX_HOST_DEVICE
  void computeViscosities( real64 pressure,
                           arraySlice1d< real64, multifluid::USD_PHASE_PROP-2 > const & phaseVisc,
                           arraySlice1d< real64, multifluid::USD_PHASE_PROP-2 > const & dPhaseVisc_dPressure,
                           arraySlice2d< real64, multifluid::USD_PHASE_PROP_DC-2 > const & dPhaseVisc_dGlobalCompFraction ) const;
...
DeadOilFluidUpdate::computeViscosities( real64 pressure,
                                        arraySlice1d< real64, multifluid::USD_PHASE_PROP-2 > const & phaseVisc,
                                        arraySlice1d< real64, multifluid::USD_PHASE_PROP-2 > const & dPhaseVisc_dPres,
                                        arraySlice2d< real64, multifluid::USD_PHASE_PROP_DC-2 > const & dPhaseVisc_dGlobalCompFrac ) const
{
