...
public:
  ...
  GEOSX_HOST_DEVICE
  virtual void compute( arraySlice1d< real64 const, compflow::USD_PHASE_PROP-1 > const & phaseVolFraction,
  ...
  virtual void update( localIndex const k,
                       localIndex const q,
                       arraySlice1d< real64 const, compflow::USD_PHASE_PROP-1 > const & phaseVolFraction ) const override
  {
...
TableRelativePermeabilityUpdate::
  compute( arraySlice1d< real64 const, compflow::USD_PHASE_PROP-1 > const & phaseVolFraction,
           arraySlice1d< real64, relperm::USD_RELPERM-2 > const & phaseRelPerm,
